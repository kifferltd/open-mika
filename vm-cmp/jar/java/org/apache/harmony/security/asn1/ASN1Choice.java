...
/*
 * Imported by CG 20090319 based on Apache Harmony ("enhanced") revision 541025.
 */
...
public abstract class ASN1Choice extends ASN1Type {
    ...
    public ASN1Choice(ASN1Type[] type) {
        ...
        if (type.length == 0) {
            throw new IllegalArgumentException("ASN.1 choice type: " + getClass().getName() + " MUST have at least one alternative");
        }
    ...
    public Object decode(BerInputStream in) throws IOException {
		...
		"Failed to decode ASN.1 choice type.  No alternatives were found for " + getClass().getName());// FIXME message
        }
