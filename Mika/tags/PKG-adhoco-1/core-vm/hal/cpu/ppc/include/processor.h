...
*   Belgium - EUROPE                                                      *
*                                                                         *
* Modifications for PPC Copyright (C) 2003 by Chris Gray, /k/ Embedded    *
* Java Solutions, Belgium.  All rights reserved.                          *
*                                                                         *
**************************************************************************/

/*
** $Id: processor.h,v 1.6 2005/10/24 14:05:45 cvs Exp $
*/

/*
** Machine dependent stuff for the PPC Architecture
*/
