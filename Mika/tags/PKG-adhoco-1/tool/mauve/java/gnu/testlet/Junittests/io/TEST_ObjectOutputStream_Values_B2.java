...
public class TEST_ObjectOutputStream_Values_B2 extends Mv_Assert {
  ...
  public TEST_ObjectOutputStream_Values_B2() {
    super();

    root=SAMPLE_SerialObject.getRootObject();
    original=(SAMPLE_ObjectStream_B)(root.getLeft());
  ...
  public void setUp() {
    ...
    check=(SAMPLE_ObjectStream_B)(((SAMPLE_ObjectStream_B)object).getLeft());
  }
