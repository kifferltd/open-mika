...
public class TEST_ObjectInputStream_Values_C2 extends Mv_Assert {
  ...
  public TEST_ObjectInputStream_Values_C2(){
    super();
    ...
    original=(SAMPLE_ObjectStream_C)SAMPLE_SerialObject.getRootObject().getLeft().getRight();
  ...
  public void setUp() {
    ...
    check=(SAMPLE_ObjectStream_C)(((SAMPLE_ObjectStream_B)object).getLeft().getRight());
  }
