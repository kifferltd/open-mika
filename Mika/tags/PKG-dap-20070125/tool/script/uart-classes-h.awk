...
#
# $Id: uart-classes-h.awk,v 1.1.1.1 2004/07/12 14:07:44 cvs Exp $
# 
...
BEGIN { 
  print "#ifndef _UART_CLASSES_H"
  print "#define _UART_CLASSES_H"
  print " "
  print "/*"
...
#  print "#include \"repository.h\""
  ...
  print "#include \"jni.h\""
  print " "
  print "void loadUartClasses(void);"
#  print "void startHandlers(void);"
  print "void collectUartFixups(void);"
  print " "
  print "/*"
