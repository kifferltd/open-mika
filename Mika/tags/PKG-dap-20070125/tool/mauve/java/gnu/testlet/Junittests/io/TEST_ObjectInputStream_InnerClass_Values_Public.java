...
public class TEST_ObjectInputStream_InnerClass_Values_Public extends Mv_Assert {


  private SAMPLE_ObjectStream_OuterClass outerClass,outerClassAfter;
  private SAMPLE_ObjectStream_B check, original;
  ...
  public TEST_ObjectInputStream_InnerClass_Values_Public() {
    super();
