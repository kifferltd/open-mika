...
public class decode implements Testlet
{
  public void test (TestHarness harness)
      ...
      catch (UnsupportedEncodingException ex)
	{
      ...
      harness.check (ok, "iiep");

      harness.checkPoint("UTF16");
      ...
      harness.check(decodeTest(leWithBOM, "UnicodeLittle", "a"), "UnicodeLittle - 1");
      harness.check(decodeTest(leWithoutBOM, "UnicodeLittle", "a"), "UnicodeLittle - 2");
      harness.check(!decodeTest(beWithBOM, "UnicodeLittle", "a"), "UnicodeLittle - 3");
      harness.check(!decodeTest(beWithoutBOM, "UnicodeLittle", "a"), "UnicodeLittle - 4");
    }
