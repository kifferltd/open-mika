...
/*
 * Imported by CG 20090910 based on Apache Harmony ("enhanced") revision 541025.
 */
    ...
    public X509CertPathImpl(List certs) throws CertificateException {
        ...
        for (int i=0; i<size; i++) {
            ...
            if (!(cert instanceof X509Certificate) ) {
                throw new CertificateException("One of provided certificates is not X509 certificate");
            }
