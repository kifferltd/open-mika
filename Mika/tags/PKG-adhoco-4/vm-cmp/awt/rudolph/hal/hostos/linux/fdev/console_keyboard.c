...
/* $Id: console_keyboard.c,v 1.1 2005/06/14 08:48:24 cvs Exp $ */
...
#define CK_SHIFT            1
#define CK_ALTR             8 // 4 Altr und Altl werden gleichbehandelt
#define CK_CTRL             2
#define CK_ALTL             8
...
//proveo modifications for shift --- begin
  {  0,  '~',      VK_BACK_QUOTE     },  
  {  0,  '!',      VK_1              },
  {  0,  '@',      VK_2              },
  {  0,  '#',      VK_3              },
...
//proveo modifications for shift --- end
...
// proveo modifier mapping
// so werden die keyboard mappings vom kernel initialisiert
#define KRNL_KBD_PLAIN		0
#define KRNL_KBD_SHIFT		1
#define KRNL_KBD_ALTGR		2
#define KRNL_KBD_CTRL		4
#define KRNL_KBD_SHIFT_CTRL     5
#define KRNL_KBD_ALT		8
#define KRNL_KBD_CTRL_ALT	12

/*
 **                                 Kernel					Wonka
 */
static w_ubyte useKernelMap[] = {   KRNL_KBD_PLAIN,		// plain		0
                                    KRNL_KBD_SHIFT,		// shift		1
                                    KRNL_KBD_PLAIN,		// ctrl			2
                                    KRNL_KBD_SHIFT,		// ctrl+shift		3		
                                    KRNL_KBD_PLAIN,		// altr			4
                                    KRNL_KBD_SHIFT,		// altr+shift		5
                                    KRNL_KBD_PLAIN,		// ctrl+altr		6
                                    KRNL_KBD_SHIFT,		// ctrl+altr+shift	7
                                    KRNL_KBD_PLAIN,		// altl			8	
                                    KRNL_KBD_SHIFT,		// altl+shift		9
                                    KRNL_KBD_PLAIN,		// ctrl+altl		10
                                    KRNL_KBD_SHIFT,		// ctrl+altl+shift	11
                                    KRNL_KBD_PLAIN,		// altl+altr		12	
                                    KRNL_KBD_SHIFT,		// altl+altr+shift	13	
                                    KRNL_KBD_PLAIN,		// ctrl+altl+altr	14	
                                    KRNL_KBD_SHIFT };		// ctrl+altl+altr+shift 15	
...
w_int keyboard_poll(w_int *VK, w_char *keychar, w_int *mod, w_int *pressed) {
  ...
  */
  ...
  woempa(9, "#: for modifier: %d use kernel map: %d\n", modifiers, useKernelMap[modifiers]);
  entry.kb_table = useKernelMap[modifiers];
  ...
  woempa(9, "#: before ask kernel for translation: modifiers: %d kb_index %d pressed: %d buf: %d\n", modifiers, entry.kb_index, *pressed, buf[i]);
  ...
  */
  ...
  woempa(9, "#: modifiers: %d pressed: %d kbd_command: %d kbd_argument %d\n", modifiers, *pressed, kbd_command, kbd_argument);
  ...
  if(kbd_command == 7) {
    ...
    */
    ...
    if(0 <= kbd_argument && kbd_argument <= 3) {
		woempa(9, "kbd_argument between 0..3\n");
