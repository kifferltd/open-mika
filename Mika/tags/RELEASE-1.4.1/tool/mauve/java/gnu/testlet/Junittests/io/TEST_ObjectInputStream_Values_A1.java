...
public class TEST_ObjectInputStream_Values_A1 extends Mv_Assert {


  private SAMPLE_ObjectStream_A original, check;
  ...
  public TEST_ObjectInputStream_Values_A1() {
    super();
    ...
    original=SAMPLE_SerialObject.getRootObject().getLeft().getLeft();
  ...
  public void setUp() {
    ...
    check=((SAMPLE_ObjectStream_B)object).getLeft().getLeft();
  }
