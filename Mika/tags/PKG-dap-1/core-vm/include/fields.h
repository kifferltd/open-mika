...
/*
** $Id: fields.h,v 1.17 2006/10/04 14:24:14 cvsroot Exp $
*/
...
** NOT COMPATIBLE WITH J-SPOT!
*/
//#define PACK_BYTE_FIELDS

#if (defined(PACK_BYTE_FIELDS) && defined(JSPOT))
#error Cannot mix J-spot with PACK_BYTE_FIELDS, sorry.
#endif
...
*/
static inline void setBooleanField(w_instance parent, w_int slot, w_boolean value) {
