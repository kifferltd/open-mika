...
public class FlowLayoutPositions extends GridLayoutPositions {

  /** Variables already defined by GridLayoutPositions * /
  ...
  */
  ...
  public FlowLayoutPositions() {
    ...
    Panel main = new Panel(new java.awt.GridLayout(3,2));
      ...
      main.add(buildLayout(title,SMOKE, new java.awt.FlowLayout(), a, b, c, d));
      ...
      main.add(buildLayout(title,RUST, new java.awt.FlowLayout(), a, -1, b, -1, c, -1, d, -1));
      ...
      main.add(buildLayout(title,RUST, new java.awt.FlowLayout(), d, c, b, a));
      ...
      main.add(buildLayout(title,SMOKE, new java.awt.FlowLayout(), a, 0, b, 0, c, 0, d, 0));
      ...
      main.add(buildLayout(title,SMOKE, new java.awt.FlowLayout(), a, b, d, c));
      ...
      main.add(buildLayout(title,RUST, new java.awt.FlowLayout(), a, 0, b, 1, c, 2, d, 2));
  ...
  public String getHelpText(){
    return "A test to verify Rudolph's implementation of the Container.add(Component, position) form in a FlowLayout :\n\n"+
           ...
           " As the FlowLayout manager uses its internal list of elements to calculate which element to come on which position,"+
