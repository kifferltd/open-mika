...
public class TextAreaVerticalVariable extends TextAreaBothFixed {
/**********************************************************************************************************************************/
/**
*	Constructors
**/
  /** Test Engine constructor */
  public TextAreaVerticalVariable() {
    super(TextArea.SCROLLBARS_VERTICAL_ONLY, false);	
  }

  public String getHelpText(){
    String help =  "Displays a text area with a vertical bar, variable width font (Helvetica 14 pt)\n"+
