...
/*
 * Imported by CG 20090513 based on Apache Harmony ("enhanced") revision 543463.
 */
...
public class DSAKeyFactoryImpl extends KeyFactorySpi {
    ...
    protected KeySpec engineGetKeySpec(Key key, Class keySpec)
        ...
        if (key != null) {
            if (keySpec == null) {
                throw new NullPointerException("'keySpec' argument is null");
            }
        ...
        if (key != null) {
            if (key instanceof DSAPrivateKey) {
                ...
                try {
                    ...
                    throw new InvalidKeyException("ATTENTION: InvalidKeySpecException in engineGeneratePrivate: " + e);
                }
            }
            ...
            if (key instanceof DSAPublicKey) {
                ...
                try {
                    ...
                    // Actually this exception shouldn't be thrown
                    throw new InvalidKeyException("ATTENTION: InvalidKeySpecException in engineGeneratePublic: " + e);
                }
            }
        }
