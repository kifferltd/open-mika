...
public class PackBorderLayoutTest extends VisualTestImpl implements ActionListener{
  ...
  */
  ...
  public void actionPerformed(ActionEvent evt) {
    ...
    if(source == showFirst) {
      if(checkFirst()) {
        ...
        displayText("first (NORTH aligned) Window shown");
      }
    }
      ...
      if(firstWindow!= null) {
        firstWindow.dispose();
        firstWindow = null;
        displayText("first (NORTH aligned) Window disposed");
      }
    }
    else if(source == showSecond) {
      if(checkSecond()) {
        secondWindow.show(); //setVisible(true);
        displayText("second (WEST aligned) Window shown");
      }
    }
      ...
      if(secondWindow!= null) {
        secondWindow.dispose();
        secondWindow = null;
        displayText("second (WEST aligned) Window disposed");
      }
    }
    else if(source == showThird) {
      if(checkThird()) {
        thirdWindow.show(); //setVisible(true);
        displayText("third (CENTER aligned) Window shown");
      }
    }
      ...
      if(thirdWindow!= null) {
        thirdWindow.dispose();
        thirdWindow = null;
        displayText("third (CENTER aligned) Window disposed");
      }
    }
    else if(source == showFourth) {
      if(checkFourth()) {
        fourthWindow.show(); //setVisible(true);
        displayText("fourth (no alignment) Window shown");
      }
    }
      ...
      if(fourthWindow!= null) {
        fourthWindow.dispose();
        fourthWindow = null;
        displayText("fourth (no alignment) Window disposed");
      }
    }
  }
  ...
  private boolean checkFirst() {
    ...
    if(vtframe == null) {
      ...
      firstWindow.add(new Label("The first (NORTH aligned) Window",Label.CENTER), BorderLayout.NORTH);
  ...
  private boolean checkSecond() {
    ...
    if(vtframe == null) {
      ...
      secondWindow.add(new Label("The second (WEST aligned) Window",Label.CENTER),BorderLayout.WEST);
  ...
  private boolean checkThird() {
    ...
    if(vtframe == null) {
      ...
      thirdWindow.add(new Label("The third (CENTER aligned) Window",Label.CENTER),BorderLayout.CENTER);
  ...
  private boolean checkFourth() {
    ...
    if(vtframe == null) {
      ...
      fourthWindow.add(new Label("The fourth (no alignment) Window",Label.CENTER));
  ...
  public String getHelpText(){
    return "Test on the construction and behavior of the java.awt.Window class:\n"+
           ...
           "the four Windows are aligned using a BorderLayout, where the label is aligned"+
           "-> to the NORTH \n"+
           "-> to the WEST\n"+
           "-> to the CENTER\n"+
           ...
           " This is because the label is added to the BorderLayout using the simple form Container.add(Component)"+
