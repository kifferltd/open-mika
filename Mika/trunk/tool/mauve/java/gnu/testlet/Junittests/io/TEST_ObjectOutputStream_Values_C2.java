...
public class TEST_ObjectOutputStream_Values_C2 extends Mv_Assert {
  ...
  public TEST_ObjectOutputStream_Values_C2() {
    super();

    root=SAMPLE_SerialObject.getRootObject();
    original=(SAMPLE_ObjectStream_C)(root.getLeft().getRight());
