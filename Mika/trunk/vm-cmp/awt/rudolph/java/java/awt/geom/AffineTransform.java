...
public class AffineTransform implements Cloneable, Serializable {
    ...
    public int hashCode() {
      ...
      */
      ...
      long hash = Double.doubleToLongBits(m00);
      hash = hash * 32767 + Double.doubleToLongBits(m01);
      hash = hash * 32767 + Double.doubleToLongBits(m02);
      hash = hash * 32767 + Double.doubleToLongBits(m10);
      hash = hash * 32767 + Double.doubleToLongBits(m11);
      hash = hash * 32767 + Double.doubleToLongBits(m12);
