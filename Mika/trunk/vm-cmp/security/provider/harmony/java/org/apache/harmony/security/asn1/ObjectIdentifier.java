...
public final class ObjectIdentifier {
    ...
    public static void validate(int[] oid) {
        ...
        if (oid[0] > 2) {
            ...
            throw new IllegalArgumentException("If the first subidentifier has 0 or 1 value the second subidentifier value MUST be less then 40.");
        }
    ...
    public static int[] toIntArray(String str) {
        ...
        if (str == null) {
            throw new IllegalArgumentException("ObjectIdentifier string is null");
        }
