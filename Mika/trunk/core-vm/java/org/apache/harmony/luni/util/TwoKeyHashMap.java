...
public class TwoKeyHashMap extends AbstractMap {
     ...
     * @return
     */
    Entry createEntry(int hashCode, Object key1, Object key2, Object value,
            Entry next) {
    ...
    class EntryIteratorImpl implements Iterator {
        ...
        private Entry curr_entry;
        private Entry returned_entry;
    ...
    class ValueIteratorImpl implements Iterator {
