...
public class TextAreaHorizontalFixed extends TextAreaBothFixed {
/**********************************************************************************************************************************/
/**
*	Constructors
**/
  /** Test Engine constructor */
  public TextAreaHorizontalFixed() {
    super(TextArea.SCROLLBARS_HORIZONTAL_ONLY, true);	
  }

  public String getHelpText(){
    String help =  "Displays a text area with a horizontal scrollbar, fixed width font (Courier 14 pt)\n"+
    "Items to test: \n"+
    " => Scrolling along horizontal scrollbar:\n"+
