...
public class TextAreaNoBarsFixed extends TextAreaBothFixed {
/**********************************************************************************************************************************/
/**
*	Constructors
**/
  /** Test Engine constructor */
  public TextAreaNoBarsFixed() {
    super(TextArea.SCROLLBARS_NONE,true);
  }

  public String getHelpText(){
    String help =  "Displays a text area without bars, fixed width font (Courier 14 pt)\n"+
