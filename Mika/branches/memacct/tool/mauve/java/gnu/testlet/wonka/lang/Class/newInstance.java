...
public class newInstance implements Testlet
{
  ...
  public void test(TestHarness harness)
  {
    ...
    try
      {
        checkFail(harness, Class.forName("gnu.testlet.wonka.lang.Class.pkg.test1"));
        checkSuccess(harness, Class.forName("gnu.testlet.wonka.lang.Class.pkg.test2"));
        checkFail(harness, Class.forName("gnu.testlet.wonka.lang.Class.pkg.test3"));
        checkFail(harness, Class.forName("gnu.testlet.wonka.lang.Class.pkg.test4"));
      }
