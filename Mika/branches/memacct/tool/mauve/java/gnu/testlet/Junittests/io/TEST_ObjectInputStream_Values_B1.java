...
public class TEST_ObjectInputStream_Values_B1 extends Mv_Assert {


  private SAMPLE_ObjectStream_B original, check;
  ...
  public TEST_ObjectInputStream_Values_B1() {
    super();
    ...
    original=SAMPLE_SerialObject.getRootObject();
  ...
  protected void runTest() 
    ...
    assertEqual(check.getD().toString(), original.getD().toString());
