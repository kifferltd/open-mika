...
/*
 * Imported by CG 20090513 based on Apache Harmony ("enhanced") revision 541025.
 */
...
public class SHA1withDSA_SignatureImpl extends Signature {
    ...
    protected void engineInitSign(PrivateKey privateKey)
        ...
        if (privateKey == null || !(privateKey instanceof DSAPrivateKey)) {
            throw new InvalidKeyException("'privateKey' is not instanceof DSAPrivateKey");
        }
    ...
    protected void engineInitVerify(PublicKey publicKey)
        ...
        if (publicKey == null || !(publicKey instanceof DSAPublicKey)) {
            throw new InvalidKeyException("'publicKey' is not instanceof DSAPublicKey");
        }
