...
/*
 * Imported from Apache Harmony CG 20060208, based on revision 587984.
...
class Division {
            ...
            if (normA[j] == firstDivisorDigit) {
                ...
                if (guessDigit != 0) {
                    ...
                    do {
                         ...
                         */
                        if (Utils.numberOfLeadingZeros((int) (longR >>> 32)) < 32) {
                            rOverflowed = true;
                        } else {
                            rem = (int) longR;
                        }
    ...
    static long gcdBinary(long op1, long op2) {
        ...
        do {
            if (op1 >= op2) {
                op1 -= op2;
                op1 >>>= Utils.numberOfTrailingZeros(op1);
            } else {
                op2 -= op1;
                op2 >>>= Utils.numberOfTrailingZeros(op2);
            }
        } while (op1 != 0);
...
//			assert k < m;
    ...
    private static Object[] almostMonInv(BigInteger a, BigInteger module) {
        ...
        return new Object[] { r, new Integer(k) };
    }
