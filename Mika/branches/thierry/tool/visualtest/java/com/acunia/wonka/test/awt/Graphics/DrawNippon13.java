...
public class DrawNippon13 extends VisualTestImpl {
  ...
  public void paint(Graphics g) {
    ...
    Font f = new Font("nippon13", 0, 13);

    fh=test(g, "Font is 'nippon13'", f, 10 , y, Color.yellow);
  ...
  public String getHelpText(){
    return ("Drawing of japanese unicode characters is visually tested. On a grey " +
            ...
            "of width 12 and height 13, from font 'nippon13' : \n " +
            "  on a first line, in yellow, the string 'Font is nippon13' \n" +
